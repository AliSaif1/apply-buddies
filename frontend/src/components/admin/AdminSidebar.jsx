...
const AdminSidebar = ({ isSidebarOpen }) => {
  ...
  return (
    <aside className={`fixed lg:sticky top-0 left-0 z-40 w-64 h-screen transition-transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 bg-primary border-r border-primary-grey`}>
      <div className="h-full overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
        <div className="p-4">
          <div className="flex items-center space-x-2 mb-8 pt-2">
            ...
            <h2 className="text-xl font-bold text-neutral font-serif">Apply Buddies</h2>
          </div>
        ...
        <div className="p-4 border-t border-primary-grey">
          <button className="flex items-center w-full px-4 py-3 text-neutral-dark hover:bg-primary-grey rounded-lg transition-colors">
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
