  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-neutral-100 flex flex-col justify-between">
      ...
      <header className="py-6 px-6 flex justify-between items-center">
        ...
        <Link 
          to="/login" 
          className="text-sm font-medium text-primary hover:text-primary-dark transition-colors whitespace-nowrap"
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border ${errors.name ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-colors`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-3 py-2 border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-colors`}
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-3 py-2 border ${errors.password ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary pr-10 transition-colors`}
                placeholder="••••••••"
              />
              <button
                type="button"
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-3 py-2 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary pr-10 transition-colors`}
                placeholder="••••••••"
              />
              <button
                type="button"
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className={`flex flex-col items-center p-3 border rounded-lg cursor-pointer transition-colors ${
                  formData.accountType === 'student' ? 'border-primary bg-primary/10' : 'border-gray-300 hover:border-gray-400'
                }`}>
                  <input
                    type="radio"
                    name="accountType"
                ...
                <label className={`flex flex-col items-center p-3 border rounded-lg cursor-pointer transition-colors ${
                  formData.accountType === 'educator' ? 'border-primary bg-primary/10' : 'border-gray-300 hover:border-gray-400'
                }`}>
                  <input
                    type="radio"
                    name="accountType"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all ${
